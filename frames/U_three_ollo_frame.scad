...
module U_three_ollo_frame(length=MotorAxisOffset+ollo_segment_thickness(1)+FrameTolerance, radius=ollo_segment_thickness(1)/2, nLayer=1, width=OlloSegmentWidth, interAxisLength=MotorWidth, tolerance=FrameTolerance) {
...
module add_U_three_ollo_frame(length=MotorAxisOffset+ollo_segment_thickness(1)+FrameTolerance, radius=ollo_segment_thickness(1)/2, nLayer=1, width=OlloSegmentWidth, interAxisLength=MotorWidth, tolerance=FrameTolerance) {
  // length is the lenght between the center of the ollo holes and the top of the frame
  // radius is the curvature of the U
  // hornAngle is the orientation of the crossOlloHole

  U_three_ollo_frame(length, radius, nLayer, width, interAxisLength, tolerance);
...
// Testing
echo("##########");
echo("In U_three_ollo_frame.scad");
